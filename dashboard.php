...
if(!isset($_SESSION[username])){
 ...
 $userDept = $_GET['deptNo'];
 $result = mysql_query("SELECT * FROM store_departments WHERE departmentNumber = $userDept") or die(mysql_error());
 if(mysql_num_rows($result) == 0){
 
	die("Invalid Department Selected.  This error has been logged and will be reviewed by an administrator");
 ...
 while($row = mysql_fetch_assoc($result)){
	...
	$deptImg = $row['departmentImagePath'];
...
<div id="page-heading"><h1 style="text-align: center; font-color: black; font-size: 45px;"><img src="<?php echo $deptImg; ?>" style="float: left; height: 125px; width: 125px;"/> &nbsp;&nbsp;<div style="valign: middle;"><?php echo $deptName; ?></div></h1></div>
