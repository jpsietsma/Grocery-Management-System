...
<div id="page-top">
	...
	<!-- start logo -->
	<div id="logo">
	<a href="index.php"><img src="images/shared/logo.png" width="350" height="40" alt="G.M.S. Home" /></a>
	</div>
	<!-- end logo -->
	...
	<form action="search.php" method="get">
		...
		<input type="text" name="q" value="" onblur="if (this.value=='') { this.value='Scan Query'; }" onfocus="if (this.value=='Scan Query') { this.value=''; }" style="color: white; font-weight: bold; background-color: #333333; border: 1px solid #666666; text-align: center; font-size: 12px;" />
		</td>
		</tr>
		<tr>
		<td>
		...
		<td>
		<input name="submit" type="image" style="height: 20px; width: 40px;" src="images/shared/top_search_btn_advanced.gif"  />
		</td>
		</tr>
		</table>
	</form>
...
<div class="nav-outer"> 
		...
		<div class="select_sub show">
			<ul class="sub">
				...
				<li><a href="scripts/deleteItem.php">Delete products</a></li>
		...
		<ul class="select"><li><a href=""><b>Price Books</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub">
			<ul class="sub">
				<li><a href="/scripts/uploadPricebook.php">Upload New Pricebook</a></li>
		...
		<ul class="select"><li><a href="admin/departments"><b>Departments</b><!--[if IE 7]><!--></a><!--<![endif]-->
		<!--[if lte IE 6]><table><tr><td><![endif]-->
		<div class="select_sub">
			<ul class="sub">
				<li><a href="/admin/scripts/viewDept.php?q=all">View all Departments</a></li>
				<li><a href="admin/scripts/editDept.php?a=add">Add Department</a></li>
				<li><a href="admin/scripts/editDept.php?a=remove">Remove Department</a></li>
				<li><a href="admin/scripts/editDept.php?a=edit">Edit Department</a></li>
