...
<div id="page-heading"><h1>Create New Product Requisition</h1></div>
...
<tr>
	...
	<td>
		...
		<div id="step-holder">
			...
			<div class="step-dark-left"><a href="">Create Requisition</a></div>
			<div class="step-dark-right">&nbsp;</div>
			<div class="step-no-off">2</div>
			<div class="step-light-left">Add Products</div>
			<div class="step-light-right">&nbsp;</div>
			<div class="step-no-off">3</div>
			<div class="step-light-left">Finalize</div>
