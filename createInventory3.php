...
<div id="page-heading"><h1>Finalize Inventory</h1></div>
...
<tr>
	...
	<td>
		...
		<!--  start step-holder -->
			...
			<div class="step-no-off" style="margin-right: 12px; margin-top: -5px; "><img src="inventory/images/icons/green_check.png" style="width: 30px; height: 30px;" title="Step One Complete" /></div>
			<div class="step-light-left"><a href="createInventory2.php">Add Items</a></div>
			<div class="step-light-right">&nbsp;</div>
			<div class="step-no">3</div>
			<div class="step-dark-left"><a href="createInventory3.php">Finalize Inventory</a></div>
			<div class="step-dark-right">&nbsp;</div>
			<div class="clear"></div>
		</div>
		<!--  end step-holder -->
			<p style="margin: 0 auto 0; font-size: 15px; font-weight: bold; text-align: center;">Please review the inventory report below and make sure all items are correct.  Push the Finalize button when you are sure all items are correct.  You will 
			have a chance in the next step to download a PDF copy of the inventory report, as well as to archive the report for download at a later time.  </p>
		<!-- start id-form -->
	...
	<tr>
			<th valign="top">Issuing Unit:</th>
			<td>	
		<select  class="styledselect_form_1">
			<option value="0">(From)</option>
			<option value="com">Commissary</option>
		</select>
		</td>
			<td>
	...
	<tr>
		...
		<td><input type="text" class="inp-form" value="<?php echo $_SESSION['username']; ?>" disabled></td>
		<td></td>
	</tr>
	<tr>
	<td></td>
	...
	<div class="bubble-inner">5MB max per file</div>
